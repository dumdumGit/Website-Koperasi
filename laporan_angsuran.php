...
WHERE (angsuran.id_pinjaman = pinjaman.id_pinjaman)
GROUP BY angsuran.id_pinjaman;");
while($array=mysql_fetch_array($selek)){
echo"

<tr><td>$array[id_angsuran]</td><td>$array[id_kategori]</td><td>$array[id_anggota]</td><td>$array[tanggal_pembayaran]</td><td>$array[angsuran_ke]</td><td>$array[besar_angsuran]</td><td>$array[keterangan]</td><td>$array[id_pinjaman]</td><td>$array[sisa_pinjaman]</td></tr>
";
}
?>
