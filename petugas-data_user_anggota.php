...
echo"<tr><td>$a[id_anggota]</td><td>$a[nama]</td><td>$a[alamat]</td><td>$a[tanggal_lahir]</td><td>$a[tempat_lahir]</td><td>$a[jenis_kelamin]</td><td>$a[status]</td><td>$a[no_telepon]</td><td>$a[keterangan]</td><td><a href='petugas-update_anggota.php?id_anggota=$a[id_anggota]'><input type='image' src='gambar/edit.jpg' width='40px' height='30px'></a></td></tr>";
}
?>
