...
$h=mysql_query("select max(id_anggota) as id_anggota from anggota");
	...
	$nourut++;
	$char="AGT";
	$idbaruuu =$char. sprintf("%02s", $nourut);
	?>
...
<tr><td>$array[username]</td><td>$array[level]</td><td>$array[id]</td><td><a href='update_data_user_anggota.php?id=$array[id]'><input type='image' src='gambar/edit.jpg' width='40px' height='30px'></a></tr>
";
}
?>
</div>
