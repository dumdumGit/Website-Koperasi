...
/*mysqL_query("select id_anggota,nama,jenis_kelamin from anggota where id_anggota like '%$_POST[cari]%' or nama like '% $_POST[cari]%' and pinjaman.keterangan='belum lunas'");
echo"<table>
<tr><td>ID Anggota</td><td>$_GET[id_anggota]</td></tr>
<tr><td>Nama</td><td>$_GET[nama]</td></tr>
<tr><td>Jenis_kelamin</td><td>$_GET[jenis_kelamin]</td></tr>
</table>";*/
echo"
<table class='border'>
...
$hasil=mysql_query("select id_pinjaman,id_anggota,besar_pinjaman,tanggal_pinjaman,tanggal_pelunasan,keterangan,lama_cicilan,sisa_pinjaman from pinjaman where id_anggota like '%$_POST[cari]%'");
while($h=mysql_fetch_array($hasil)){
echo"

<tr><td>$h[id_pinjaman]</td><td>$h[id_anggota]</td><td>$h[besar_pinjaman]</td><td>$h[tanggal_pinjaman]</td><td>$h[tanggal_pelunasan]</td><td>$h[keterangan]</td><td>$h[lama_cicilan]</td><td>$h[sisa_pinjaman]</td><td><a href='bayar_angsuran.php?id_pinjaman=$h[id_pinjaman]'>Angsuran</a></td></tr>
";
}
?>
</div>
