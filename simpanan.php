...
$h=mysql_query("select max(id_simpanan) as id_simpanan from simpanan");
...
<tr><td><span>Nama_Simpanan</span></td><td>:</td><td><select name="nama_simpanan" id="textfield"><option>Simpanan Pokok</option>
...
<tr><td><span>Keterangan</span></td><td>:</td><td><textarea id="textfield" name="keterangan" rows="5" cols="20"></textarea>
                                                      </td>
</tr>
...
";
$selek=mysql_query("select * from simpanan");
